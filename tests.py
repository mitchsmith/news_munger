...
class TestAggregator(unittest.TestCase):
    ...
    def test_collect_and_cache_ap_headlines(self):
        ...
        self.assertTrue(self.hlcount > 0, "no headline data was feched")

    def test_cache_headlines(self):
        self.assertTrue(os.path.isfile("headlines.json"), "cache file not found")
    ...
    def test_fetch_story_appends_to_stories(self):
        ...
        self.assertTrue(len(self.ag._stories) == 1, "Failed to retrieve article.")
...
class TestPersonChunker(unittest.TestCase):
    ...
    def test_chunker_labels_first_names(self):
        ts = nltk.pos_tag(
            word_tokenize("Franklin loves Dunkin Donuts, and so does Sharon.")
        )
    ...
    def test_chunker_labels_last_names(self):
        ...
        self.assertEqual(len(snames), 2, "found more than two names: {}".format(snames))
...
class TestPersonScanner(unittest.TestCase):
    ...
    def test_person_scanner_finds_people(self):
        ...
        self.assertTrue(
            "Atlanta Mayor Keisha Lance Bottoms" in self.scanner._people,
